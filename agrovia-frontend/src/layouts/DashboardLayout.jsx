...
import { LayoutDashboard, ShoppingCart, Heart, Package, Truck, ShieldAlert, LogIn } from 'lucide-react';
      ...
      <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
        <aside className="panel h-fit">
          ...
          <div className="mt-6 rounded-3xl bg-slate-950 p-4 text-white">
            <div className="flex items-center gap-2 text-sm font-semibold"><ShieldAlert className="h-4 w-4 text-sun" />Live API ready</div>
            <p className="mt-2 text-sm leading-6 text-white/70">Token localStorage-da saxlanır və backend endpoint-lərinə request header ilə ötürülür.</p>
          </div>
        </aside>
