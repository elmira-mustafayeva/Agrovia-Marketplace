...
// Protected seller routes — uploadProductMedia must run before validateProduct
// so that req.body is populated from the multipart form before validation runs
router.post('/', protect, authorize('seller', 'admin'), uploadProductMedia, validateProduct, createProduct);
router.put('/:id', protect, authorize('seller', 'admin'), uploadProductMedia, validateProduct, updateProduct);
